...
class Pintor implements GLEventListener {
    ...
    public void display(GLAutoDrawable glad) {
        ...
        gl.glColor3f(0.0f, 20.0f, 196.0f);
        ...
        gl.glBegin(GL2.GL_QUADS);            
            gl.glVertex3f(1.1f, 2.1f, 1.1f);            
            gl.glVertex3f(1.f, 1.0f, 1.0f);            
            gl.glVertex3f(1.4f, 2.0f, -1.0f);
            gl.glVertex3f(1.2f, 2.0f, -2.2f);  
        gl.glEnd();        

        gl.glBegin(GL2.GL_QUADS);
            gl.glColor3f(0.00f, 1.0f, 1.0f);
