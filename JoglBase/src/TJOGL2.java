...
public class TJOGL2 extends GLCanvas implements GLEventListener, KeyListener {
   ...
   public void init(GLAutoDrawable drawable) {
      ...
      float[] ambientLight = { 0.7f, .7f, .7f,0.7f };  // weak RED ambient 
      gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_AMBIENT, ambientLight, 0); 
      float[] diffuseLight = { .9f,.9f,.9f,0f };  // multicolor diffuse 
      gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_DIFFUSE, diffuseLight, 0); 
      float[] specularLight = { 2f,2f,2f,2f };  // specular 
      gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_SPECULAR, specularLight, 0);       
              
      gl.glEnable(GL2.GL_LIGHTING);      
      gl.glEnable(GL2.GL_LIGHT0);
      
      this.textura1 = this.cargarTextura("imagenes/onepiece.jpg");
